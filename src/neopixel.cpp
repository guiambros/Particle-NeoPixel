...
/*-------------------------------------------------------------------------
  This file is part of the Adafruit NeoPixel library, available at 
  https://github.com/adafruit/Adafruit_NeoPixel

  Modifications were indicated by '**MODIFIED' tag
  -------------------------------------------------------------------------*/
/*!
...
/*!
  **MODIFIED
  @source  technobly -- https://github.com/technobly/Particle-NeoPixel
 */
...
Adafruit_NeoPixel::Adafruit_NeoPixel() :
  ...
  is800KHz(true),
#endif
  begun(false), type(0), numLEDs(0), numBytes(0), pin(-1), brightness(0), pixels(NULL),
...
void Adafruit_NeoPixel::updateType(neoPixelType t) {
  ...
  /*  **MODIFIED from original Adafruit source code
  */
  switch(t) {
    case WS2811: {
      t = NEO_GRB | NEO_KHZ400;
    } break;
    
    case TM1829: {
      t = NEO_RBG | NEO_KHZ800;
    } break;

    case TM1803: {
      t = NEO_RGB | NEO_KHZ400;
    } break;
